...
This is a fork from the original Gos Web Socket Bundle adapted to a specific project with a wierd login system using jwt. Before you use this fork, please check the code changes that have been made.
